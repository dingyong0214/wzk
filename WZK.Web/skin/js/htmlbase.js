...
var basehtml={
		...
		/*
		      ...
		      <div class="v3_top_main">
		          ...
		          <div class="t_right">
		              ...
		              <div class="t_right_m top_cart">
		                  <a href="http://cart.cayiWZK.com/"><span></span>购物车<i>12</i></a>
		              </div>
		              <div class="t_right_m">
		                  <div class="t_right_show">
		  ...
		  <div class="v3_search_w">
		      ...
		      <div class="v3_gwch head_cart">
		          <a href="http://cart.cayiWZK.com/">我的购物车<span>33</span>件</a>
		      </div>
		  </div>
		  <div class="v3_nav_w">
		      <div class="v3_nav">
	...
	footer:function(){
		/*
		    ...
		    <input type="hidden" id="lazy_img" name="name" value="http://imgs.cayiWZK.com/img/1.0.0/c2.png" />
		    <script>
			    $(function () {
			        //搜索
